...
export default function Generate() {
  ...
  const handleGenerateReadme = async () => {
    const res = await fetch('/api/generate_readme', {
      method: 'POST',
      headers: {
  ...
  return (
    <div className="relative flex flex-col items-center justify-center min-h-screen bg-black">
      ...
      <div className="relative z-10 flex flex-col items-center">
        ...
        <input
          type="text"
          className="px-4 py-2 rounded-lg shadow-sm w-80 sm:w-96 mb-4 border border-gray-300 focus:ring focus:ring-indigo-200"
